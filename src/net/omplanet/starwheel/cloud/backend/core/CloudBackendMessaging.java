...
public class CloudBackendMessaging extends CloudBackendAsync {
     ...
     * StarWheel related preferences.
     * 
     * @return {@link SharedPreferences}
     */
    public SharedPreferences getSharedPreferences() {
        return application
                .getSharedPreferences(Consts.PREF_KEY_STARWHEEL, Context.MODE_PRIVATE);
    }
    ...
    /**
     * Cloud message properties.
     */
    public static final String BROADCAST_PROP_MESSAGE = "message";
    public static final String BROADCAST_PROP_DURATION = "duration";
