...
import net.omplanet.starwheel.ui.navigation.common.view.SlidingTabLayout;

import java.util.ArrayList;
import java.util.List;

/**
 * A basic sample which shows how to use {@link net.omplanet.starwheel.ui.navigation.common.view.SlidingTabLayout}
