...
import net.omplanet.starwheel.ui.adapter.PhotoAdapter;
...
public class PhotosRecyclerViewFragment extends Fragment {
    ...
    private final static String TAG = PhotosRecyclerViewFragment.class.getName();
    ...
    private Response.Listener<MessageData> createMyReqSuccessListener() {
        return new Response.Listener<MessageData>() {
            ...
            public void onResponse(MessageData response) {
                ...
                mAdapter = new PhotoAdapter(mDataset);
