...
public class GsonRequest<T> extends Request<T>{
	...
	public GsonRequest(int method
		...
		mGson = new Gson();
        //TODO consider the parsing issue of infinite loop whe type is overloaded
//        GsonBuilder gsonBuilder = new GsonBuilder();
//        gsonBuilder.registerTypeAdapter(Person.class, new JsonLdDeserializer());
//        gsonBuilder.registerTypeAdapter(Group.class, new JsonLdDeserializer());
